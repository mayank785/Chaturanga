...
bk = Piece('b', 'k', 'Images//king_black.png')
wk = Piece('w', 'k', 'Images//king_white.png')
br = Piece('b', 'r', 'Images//rook_black.png')
wr = Piece('w', 'r', 'Images//rook_white.png')
bb = Piece('b', 'b', 'Images//elephant_black.png')
wb = Piece('w', 'b', 'Images//elephant_white.png')
bq = Piece('b', 'q', 'Images//queen_black.png')
wq = Piece('w', 'q', 'Images//queen_white.png')
bkn = Piece('b', 'kn', 'Images//horse_black.png')
wkn = Piece('w', 'kn', 'Images//horse_white.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'rook_black.png'), Piece('b', 'kn', 'horse_black.png'), Piece('b', 'b', 'elephant_black.png'), \
               Piece('b', 'q', 'queen_black.png'), Piece('b', 'k', 'king_black.png'), Piece('b', 'b', 'camel_black.png'), \
               Piece('b', 'kn', 'horse_black.png'), Piece('b', 'r', 'rook_black.png')]

    board[7] = [Piece('w', 'r', 'rook_white.png'), Piece('w', 'kn', 'horse_white.png'), Piece('w', 'b', 'elephant_white.png'), \
               Piece('w', 'q', 'queen_white..png'), Piece('w', 'k', 'king_white.png'), Piece('w', 'b', 'camel_white.png'), \
               Piece('w', 'kn', 'horse_white.png'), Piece('w', 'r', 'rook_white.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'pawn_black.png')
        board[6][i] = Piece('w', 'p', 'pawn_white.png')
    return board
...
def bishop_moves(index):
    diagonals = [[[index[0] + i, index[1] + i] for i in range(1, 3)],
                 [[index[0] + i, index[1] - i] for i in range(1, 3)],
                 [[index[0] - i, index[1] + i] for i in range(1, 3)],
                 [[index[0] - i, index[1] - i] for i in range(1, 3)]]
